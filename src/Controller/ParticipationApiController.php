...
class ParticipationApiController extends AbstractController
{
    ...
    #[Route('/artist/participate/{eventid}/{userid}', name: 'parrr', methods: ['GET', 'POST'])]
    public function neww(EntityManagerInterface $entityManager, $eventid, $userid): JsonResponse
    {
        ...
        $artist = $userRepository->find($userid);
